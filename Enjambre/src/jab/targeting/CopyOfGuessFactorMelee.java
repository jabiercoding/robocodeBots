 ...
 * @author Jabi
 */
public class CopyOfGuessFactorMelee extends Targeting {

	final static double BOT_WIDTH= 36;
	
	public CopyOfGuessFactorMelee(Module bot) {
		super(bot);
	}
	...
	public void target() {
		...
		System.out.println(Math.toDegrees(bot.getGunTurnRemainingRadians()));
		...
		if (bot.enemy!=null){
			//System.out.println("Current Enemy: "+bot.enemy.name);
